...
export const metadata: Metadata = {
	title: { absolute: "404 - Page Not Found | Osifemi Osibemekun" },
	description:
...
export default function NotFound() {
	...
	return (
		<main id="main-content" tabIndex={-1} className="relative bg-black-100 flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10 px-5">
